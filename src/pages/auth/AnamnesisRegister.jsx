    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      >
        {({
          ...
          >
            <h1 className="font-semibold text-lg">Klinik Geçmişi</h1>
            <div>
              <select
            ...
            >
              <button
                ...
                type="submit"
              >
                <span className="w-full z-0 bg-gray-400 absolute h-full left-0 top-0"></span>
                <span className="z-10 relative">İleri(3/3)</span>
              </button>
            </div>
          </form>
        )}
...
export default AnammneisisRegister;
